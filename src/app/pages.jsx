...
import WorksPage from './services/ServicePageItem'

// Dynamically import ProjectShowcase and FaShareAlt to reduce initial bundle size
const ProjectShowcase = dynamic(() => import('./projects/ProjectShow'), { ssr: false })
const FaShareAlt = dynamic(() => import('react-icons/fa').then(mod => mod.FaShareAlt), { ssr: false })
